...
export default function WhatsAppButton() {
  // Only render if phone number is configured
  if (!SITE_CONFIG.phone) return null;

  // Strip non-numeric chars for wa.me link
  const phoneClean = SITE_CONFIG.phone.replace(/[^0-9+]/g, '');
  const waUrl = `https://wa.me/${phoneClean.replace('+', '')}`;
